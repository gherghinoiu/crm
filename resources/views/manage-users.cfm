    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3 justify-content-center">
                <div class="col-sm-3">
                    <button class="open-button" onclick="toggleForm()">Manage user</button>
                    ...
                    <div class="form-popup" id="myForm">
                        <form action="#" class="form-container">
                            ...
                            <input type="text" class="form-control" id="validationCustom05" value="Gigel" placeholder="First name"/>
                            <label for="psw"><b>Last name</b></label>
                            <input type="text" class="form-control" id="validationCustom05" value="Popescu" placeholder="Last name"/>
